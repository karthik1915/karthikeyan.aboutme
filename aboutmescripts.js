...
var windowScrolled;
  ...
  window.addEventListener("scroll", function windowScroll() {
    ...
    document.getElementById("ParallaxContent").style.transform ="translate3d(0, " + windowScrolled / 2 + "px, 0)";
  });
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      if (typeof gsap !== "undefined" && typeof gsap.utils.toArray === "function" && typeof ScrollTrigger !== "undefined") {
        ...
        gsap.to(menu,{
          ...
          console.error("ScrollTrigger plugin not found. Make sure it is properly loaded.");
      }
    });
